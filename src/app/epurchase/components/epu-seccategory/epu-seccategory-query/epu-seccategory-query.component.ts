...
@Component({
    selector: 'app-epu-seccategory-query',
    templateUrl: './epu-seccategory-query.component.html',
    styleUrls: ['./epu-seccategory-query.component.less']
})
export class EpuSecCategoryQueryComponent implements OnInit {
    // query form
