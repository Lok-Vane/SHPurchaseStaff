...
@Component({
    selector: 'app-epu-fircategory-query',
    templateUrl: './epu-fircategory-query.component.html',
    styleUrls: ['./epu-fircategory-query.component.less']
})
export class EpuFirCategoryQueryComponent implements OnInit {
    // query form
