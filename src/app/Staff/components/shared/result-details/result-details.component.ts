...
import { ResultPrice } from 'src/app/Staff/domains/result.domain';
import { ProductInfo } from 'src/app/Staff/domains/product.domain';
  ...
  ngOnInit() {
    ...
    this.activatedRoute.paramMap.subscribe((params: any) => {
      ...
      this.dao.doPostRequest(this.SHPurchase.PurchaseBidSearch, postData).subscribe((res: any) => {
        ...
        this.dao.doPostRequest(this.SHPurchase.PurchaseGetResult, this.bizId).subscribe((res1: any) => {
